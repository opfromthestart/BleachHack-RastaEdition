		...
		for (Command c : getCommands()) {
			if (c.hasAlias(split[0])) {
				try {
					...
					MutableText text = new LiteralText("\u00A72" + Command.PREFIX + c.getAliases()[0] + " - \u00a7f" + c.getDescription());
					Text tooltip = new LiteralText(
							"\u00a72Category: " + c.getCategory()
							+ "\n\u00A72Aliases: \u00a7f" + Command.PREFIX + String.join(" \u00a77/\u00a7f " + Command.PREFIX, c.getAliases())
